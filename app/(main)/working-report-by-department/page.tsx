...
import ReportTable from '@/app/features/working-report-by-department/components/report-table'
import { useReport } from '@/app/features/working-report-by-department/hook/use.report'
...
export default function WorkingReprotByDepartmentPage() {
    ...
    return (
        <div className="flex flex-col gap-4">
            <div>
                <h1 className="text-xl font-semibold">Working Report (แผนกฉัน)</h1>
